...
public class TesteMovimentacaoComCategoriaExistente {
	...
	public static void main(String[] args) {
		...
		Categoria cat1 = em.find(Categoria.class, 3L);
		Categoria cat2 = em.find(Categoria.class, 4L);
		
		Conta conta = new Conta();
		conta.setId(3L); // ou setId((long) 1)
